#!/bin/bash
#BSUB -J points-block-diagonal-variable-131072-0
#BSUB -o points-block-diagonal-variable-131072-0.o%J
#BSUB -e points-block-diagonal-variable-131072-0.e%J
#BSUB -W 02:00
#BSUB -nnodes 1
...
mats=\
"
$ROOT/static/block-diagonal-variable_131072_*_*_0_0.mtx \
$ROOT/static/block-diagonal-variable_131072_*_*_0_0_pad16.mtx \
$ROOT/static/block-diagonal-variable_131072_*_*_0_0.mtx_v-cycle.mtx \
"
