#!/bin/bash
#BSUB -J points-block-diagonal-variable-131072-1000
#BSUB -o points-block-diagonal-variable-131072-1000.o%J
#BSUB -e points-block-diagonal-variable-131072-1000.e%J
#BSUB -W 04:00
#BSUB -nnodes 1
...
mats=\
"
$ROOT/static/block-diagonal-variable_131072_*_*_1000_0.mtx \
$ROOT/static/block-diagonal-variable_131072_*_*_1000_0_pad16.mtx \
"
