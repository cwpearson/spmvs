#!/bin/bash
#BSUB -J points-block-variable-131072-1000
#BSUB -o points-block-variable-131072-1000.o%J
#BSUB -e points-block-variable-131072-1000.e%J
#BSUB -W 04:00
#BSUB -nnodes 1
...
mats=\
"
$ROOT/static/block-variable_131072_*_*_*_1000_0.mtx \
$ROOT/static/block-variable_131072_*_*_*_1000_0_pad16.mtx \
"
