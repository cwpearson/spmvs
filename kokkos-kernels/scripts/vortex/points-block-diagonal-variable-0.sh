#!/bin/bash
#BSUB -J points-block-diagonal-variable-0
#BSUB -o points-block-diagonal-variable-0.o%J
#BSUB -e points-block-diagonal-variable-0.e%J
#BSUB -W 04:00
#BSUB -nnodes 1
...
mats=\
"
$ROOT/static/block-diagonal-variable_16384_*_*_0_0.mtx \
$ROOT/static/block-diagonal-variable_16384_*_*_0_0_pad16.mtx \
$ROOT/static/block-diagonal-variable_1024_*_*_0_0.mtx \
$ROOT/static/block-diagonal-variable_1024_*_*_0_0_pad16.mtx \
"
